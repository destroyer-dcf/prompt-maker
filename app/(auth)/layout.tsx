...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="grid min-h-screen grid-cols-1 bg-[--surface] lg:grid-cols-[1.2fr_1fr]">
      <section className="relative hidden bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-800 p-10 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <p className="text-xs text-zinc-300">Acceso cerrado por invitación del administrador.</p>
      </section>
